...
<head>
    ...
    <title>IPMS - Check Attendance Data</title>
</head>
...
<body>
    ...
    ?>
    <div class="title" style="font-size:40px; text-align:center">See Attendance Form Data</div>

    <br>
    <div class="form" style="padding: 50px; margin-bottom: 10%;">
        <form action="stud_attendance.php" method="POST" style="margin-top: 19%;">
            <div class="form-icon">
